...
@SpringBootTest
class BoardGameEventConstraintProviderTest {
    ...
    @Autowired
    ConstraintVerifier<BoardGameEventConstraintProvider, BoardGameEvent> constraintVerifier;
    ...
    void roomConflict() {
        ...
        constraintVerifier.verifyThat(BoardGameEventConstraintProvider::roomConflict)
    ...
    void teacherConflict() {
        ...
        constraintVerifier.verifyThat(BoardGameEventConstraintProvider::teacherConflict)
                .given(firstLesson, conflictingLesson, nonConflictingLesson)
                .penalizesBy(1);
    }
    ...
    void studentGroupConflict() {
        ...
        Lesson nonConflictingLesson = new Lesson(3, "Subject3", "Teacher3", "Group3", TIMESLOT2, ROOM1);
        constraintVerifier.verifyThat(BoardGameEventConstraintProvider::studentGroupConflict)
                .given(firstLesson, conflictingLesson, nonConflictingLesson)
                .penalizesBy(1);
    }
    ...
    void teacherRoomStability() {
        ...
        constraintVerifier.verifyThat(BoardGameEventConstraintProvider::teacherRoomStability)
    ...
    void teacherTimeEfficiency() {
        ...
        constraintVerifier.verifyThat(BoardGameEventConstraintProvider::teacherTimeEfficiency)
    ...
    void studentGroupSubjectVariety() {
        ...
        constraintVerifier.verifyThat(BoardGameEventConstraintProvider::studentGroupSubjectVariety)
